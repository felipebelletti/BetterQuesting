...
public class PresetGUIs {
    ...
    public static final GuiKey<GArgsCallback<BigItemStack>> EDIT_ITEM = new GuiKey<>(new ResourceLocation(ModReference.MODID, "edit_item"));
    public static final GuiKey<GArgsCallback<FluidStack>> EDIT_FLUID = new GuiKey<>(new ResourceLocation(ModReference.MODID, "edit_fluid"));
    public static final GuiKey<GArgsCallback<Entity>> EDIT_ENTITY = new GuiKey<>(new ResourceLocation(ModReference.MODID, "edit_entity"));
