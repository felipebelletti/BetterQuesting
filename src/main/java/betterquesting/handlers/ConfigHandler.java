...
public class ConfigHandler {
    ...
    public static void initConfigs() {
        ...
        BQ_Settings.curTheme = config.getString("Theme", Configuration.CATEGORY_GENERAL, new ResourceLocation(ModReference.MODID, "light").toString(), "The current questing theme");
