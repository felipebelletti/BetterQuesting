...
public class GuiEditTaskTame extends GuiScreenCanvas implements IVolatileScreen {
    ...
    public GuiEditTaskTame(GuiScreen parent, DBEntry<IQuest> quest, TaskTame task) {
        super(parent);
        this.quest = quest;
        this.task = task;
    }
    ...
    public void initPanel() {
        ...
        cvBackground.addPanel(new PanelTextBox(new GuiTransform(GuiAlign.TOP_EDGE, new GuiPadding(16, 16, 16, -32), 0), QuestTranslation.translate("bq_standard.title.edit_tame")).setAlignment(1).setColor(PresetColor.TEXT_HEADER.getColor()));
